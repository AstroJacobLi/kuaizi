...
figlist = os.listdir('/scratch/gpfs/jiaxuanl/Data/HSC/LSBG/Figure/')
...
os.system('cp /scratch/gpfs/jiaxuanl/Data/HSC/LSBG/Figure/candy-*-zoomin-*.png /tigress/jiaxuanl/public_html/candy/gpfs_scarlet_zoomin')
...
for k in range(page_num):
    f = open(f'/tigress/jiaxuanl/public_html/candy/gpfs_scarlet_zoomin/page{k + 1}.html', 'w')
