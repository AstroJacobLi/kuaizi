...
def run_scarlet_wvlt(index, cat, starlet_thresh=0.5, global_logger=None, fail_logger=None):
...
def multiprocess_fitting(njobs, cat_dir, ind_list=None, low=0, high=None, suffix='', starlet_thresh=0.5):
    ...
    pool.map(partial(run_scarlet_wvlt, cat=lsbg_cat, starlet_thresh=starlet_thresh,
