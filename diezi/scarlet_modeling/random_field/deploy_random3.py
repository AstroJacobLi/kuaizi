...
############ VANILLA #############
# python deploy_random3.py --name rdm3_vnl.0.5k --ncpu=12 --method=vanilla --low=0 --high=500 --monotonic=True --bkg=True -min_grad=-0.02
# python deploy_random3.py --name rdm3_vnl.1.0k --ncpu=12 --method=vanilla --low=500 --high=1000 --monotonic=True --bkg=True -min_grad=-0.02
# python deploy_random3.py --name rdm3_vnl.1.5k --ncpu=12 --method=vanilla --low=1000 --high=1500 --monotonic=True --bkg=True -min_grad=-0.02
# python deploy_random3.py --name rdm3_vnl.2.0k --ncpu=12 --method=vanilla --low=1500 --high=None --monotonic=True --bkg=True -min_grad=-0.02


############ SPERGEL #############
# python deploy_random3.py --name rdm3_spgl.0.5k --ncpu=12 --method=spergel --low=0 --high=500 --monotonic=True --bkg=True --min_grad=-0.05
# python deploy_random3.py --name rdm3_spgl.1.0k --ncpu=12 --method=spergel --low=500 --high=1000 --monotonic=True --bkg=True --min_grad=-0.05
# python deploy_random3.py --name rdm3_spgl.1.5k --ncpu=12 --method=spergel --low=1000 --high=1500 --monotonic=True --bkg=True --min_grad=-0.05
# python deploy_random3.py --name rdm3_spgl.2.0k --ncpu=12 --method=spergel --low=1500 --high=None --monotonic=True --bkg=True --min_grad=-0.05
