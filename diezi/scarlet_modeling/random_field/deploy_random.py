...
############ VANILLA #############
# python deploy_random.py --name random1 --ncpu=12 --method=vanilla \
# --low=0 --high=None --monotonic=True --bkg=True -min_grad=-0.02 --sigma=0.05 --only_measure=True

############ SPERGEL #############
# python deploy_random.py --name rdm1_spgl --ncpu=12 --method=spergel \
# --low=0 --high=None --monotonic=True --bkg=True -min_grad=-0.1 --sigma=0.05

# python deploy_random.py --name rdm1_spgl --ncpu=12 --method=spergel --low=0 --high=None --monotonic=True --bkg=True --min_grad=-0.05
