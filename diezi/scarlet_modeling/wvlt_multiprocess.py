...
fail_logger = kz.utils.set_logger(logger_name='candy_sample', file_name='candy_fail', level='ERROR')
...
def multiprocess_fitting(njobs, low=0, high=10, starlet_thresh=0.5):
