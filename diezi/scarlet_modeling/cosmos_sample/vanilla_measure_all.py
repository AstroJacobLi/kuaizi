...
def run_all(low=0, high=373, lsbg_cat_dir='./Catalog/COSMOS/cosmos_cutout_cat_COSMOS.fits',
            filename='./Catalog/COSMOS/_lsbg_measure_vanilla.fits', suffix=''):

    global_logger = kz.utils.set_logger(
        logger_name='cosmos_measure_sample' + suffix, file_name='cosmos_measure_log' + suffix, level='INFO')
    ...
    for ind in range(low, high):
        measure_vanilla(
            ind, lsbg_cat, meas_cat, model_dir='/tigress/jiaxuanl/Data/HSC/LSBG/Model/COSMOS',
