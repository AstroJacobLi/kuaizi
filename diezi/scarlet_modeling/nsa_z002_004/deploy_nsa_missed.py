...
def deploy_modeling_job(low=0, high=1000, ind_list=None, name='nsa_z001_004_missed', ncpu=32,
                        method='wavelet', starlet_thresh=0.5, monotonic=True, bkg=True, min_grad=-0.001,
                        variance=0.03**2, scales=[0, 1, 2, 3, 4, 5, 6], sigma=None, only_measure=False):
    ...
    measure_content = '\n'.join([f"python ../script/sclt_meas_mp.py \\",
                                 ...
                                 f"    --PREFIX '{PREFIX}' \\",
                                 f"    --cat_dir '{CAT_DIR}' \\",
                                 f"    --filename './missed/_lsbg_meas_{method}.fits' \\",
...
############ VANILLA #############
# 06.24.22
# python deploy_nsa_missed.py --name vnl_0.5k --ncpu=12 --method=vanilla --low=0 --high=500 --monotonic=True --bkg=True --min_grad=-0.02 --sigma=0.05
# python deploy_nsa_missed.py --name vnl_1.0k --ncpu=12 --method=vanilla --low=500 --high=1000 --monotonic=True --bkg=True --min_grad=-0.02 --sigma=0.05
# python deploy_nsa_missed.py --name vnl_1.5k --ncpu=12 --method=vanilla --low=1000 --high=1500 --monotonic=True --bkg=True --min_grad=-0.02 --sigma=0.05
# python deploy_nsa_missed.py --name vnl_2.0k --ncpu=12 --method=vanilla --low=1500 --high=2000 --monotonic=True --bkg=True --min_grad=-0.02 --sigma=0.05
# python deploy_nsa_missed.py --name vnl_2.5k --ncpu=12 --method=vanilla --low=2000 --high=None --monotonic=True --bkg=True --min_grad=-0.02 --sigma=0.05
...
# 06.27.22
# python deploy_nsa_missed.py --name spgl_0.5k --ncpu=12 --method=spergel --low=0 --high=500 --monotonic=True --bkg=True --min_grad=-0.05
# python deploy_nsa_missed.py --name spgl_1.0k --ncpu=12 --method=spergel --low=500 --high=1000 --monotonic=True --bkg=True --min_grad=-0.05
# python deploy_nsa_missed.py --name spgl_1.5k --ncpu=12 --method=spergel --low=1000 --high=1500 --monotonic=True --bkg=True --min_grad=-0.05
# python deploy_nsa_missed.py --name spgl_2.0k --ncpu=12 --method=spergel --low=1500 --high=2000 --monotonic=True --bkg=True --min_grad=-0.05
# python deploy_nsa_missed.py --name spgl_2.5k --ncpu=12 --method=spergel --low=2000 --high=None --monotonic=True --bkg=True --min_grad=-0.05
